...
| 카카오 채널 채팅 | http://pf.kakao.com/_IHxegn/chat | 실제 채팅 테스트 |
...
#### 방법 B: 카카오톡 실제 채팅 (권장)
1. http://pf.kakao.com/_IHxegn/chat 접속
2. 카카오톡 앱으로 연결됨
3. 실제 챗봇과 대화 테스트
...
### 프로젝트 관리
- 카카오 채널 채팅: http://pf.kakao.com/_IHxegn/chat
- 봇 관리: https://chatbot.kakao.com/
